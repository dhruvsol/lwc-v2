...
export const Riya = (props: MemberInfo) => {
  ...
  return (
    <>
      <div className="relative flex flex-col items-center my-4 w-[33.333%] min-w-[340px]">
        <div className="absolute z-0 top-0 bg-[#2b1225] dark:bg-[#fbd8c5] aspect-square w-8 rounded-full -translate-x-20 translate-y-36"></div>
